...
<body id="body">
    ...
    <script type="module">
        ...
        testSystem.loadFromFile(ResourceManager.readFile("map1.txt"));

        const fileText2 = ResourceManager.readFile("map2.txt");
        const testSystem2 = new FileSystem();
        testSystem2.loadFromFile(fileText2);

        const fileText3 = ResourceManager.readFile("map3.txt");
        const testSystem3 = new FileSystem();
        testSystem3.loadFromFile(fileText3);

        const fileText4 = ResourceManager.readFile("map1.txt");
        const testSystem4 = new FileSystem();
        testSystem4.loadFromFile(fileText4);
        ...
        const terminal = new Terminal(desktop, 0, testSystem, testSystem2, testSystem3, testSystem4);
